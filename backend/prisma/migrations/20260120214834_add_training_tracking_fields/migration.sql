...
INSERT INTO "new_Prediction" ("accuracyScore", "actualChange", "actualDirection", "actualPrice", "asset", "assetType", "changeAccuracy", "confidence", "createdAt", "currency", "currentPrice", "direction", "directionCorrect", "expiresAt", "factorBreakdown", "factorWeights", "historicalData", "id", "macroData", "newsData", "periodHigh", "periodLow", "predictedChange", "predictedPriceMax", "predictedPriceMin", "priceError", "quality", "reasoning", "sentimentData", "symbol", "targetPrice", "targetReached", "targetReachedAt", "technicalData", "timeframe", "timeframeDays", "uncertaintyData", "uncertaintyScore", "verified", "verifiedAt", "volatility", "volatilityCategory", "withinRange") SELECT "accuracyScore", "actualChange", "actualDirection", "actualPrice", "asset", "assetType", "changeAccuracy", "confidence", "createdAt", "currency", "currentPrice", "direction", "directionCorrect", "expiresAt", "factorBreakdown", "factorWeights", "historicalData", "id", "macroData", "newsData", "periodHigh", "periodLow", "predictedChange", "predictedPriceMax", "predictedPriceMin", "priceError", "quality", "reasoning", "sentimentData", "symbol", "targetPrice", "targetReached", "targetReachedAt", "technicalData", "timeframe", "timeframeDays", "uncertaintyData", "uncertaintyScore", "verified", "verifiedAt", "volatility", "volatilityCategory", "withinRange" FROM "Prediction";
